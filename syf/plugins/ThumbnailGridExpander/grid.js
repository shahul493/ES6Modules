...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.$href = $( '<a href="appointment-form.html" class="btn btn-default">Appointment</a>' );
			this.$href2 = $( '<a href="single-profile.html" class="btn btn-primary">See all Doctors</a>' );
